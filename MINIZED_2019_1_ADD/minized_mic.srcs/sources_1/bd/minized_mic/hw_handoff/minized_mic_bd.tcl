...
################################################################
# This is a generated script based on design: minized_mic
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO [get_bd_intf_ports pl_led_g] [get_bd_intf_pins axi_gpio_1/GPIO]
  ...
  connect_bd_net -net pdm_filt_0_audio_ce [get_bd_pins ila_1/probe0] [get_bd_pins pdm_filt_0/audio_ce]
  connect_bd_net -net pdm_filt_0_audio_out [get_bd_pins ila_1/probe1] [get_bd_pins pdm_filt_0/audio_out]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins ila_0/clk] [get_bd_pins ila_1/clk] [get_bd_pins microphone_mgr_0/clk_in] [get_bd_pins pdm_filt_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK2]
