...
--               c:/Users/solbj/AppData/Roaming/Xilinx/Projects/minized_mic/MINIZED_2019_1/minized_mic.srcs/sources_1/bd/minized_mic/ip/minized_mic_microphone_mgr_0_0/minized_mic_microphone_mgr_0_0_sim_netlist.vhdl
...
entity minized_mic_microphone_mgr_0_0_microphone_mgr is
  port (
  ...
  attribute ORIG_REF_NAME of minized_mic_microphone_mgr_0_0_microphone_mgr : entity is "microphone_mgr";
end minized_mic_microphone_mgr_0_0_microphone_mgr;

architecture STRUCTURE of minized_mic_microphone_mgr_0_0_microphone_mgr is
  ...
  signal audio_overclock_count_reg : STD_LOGIC_VECTOR ( 4 downto 0 );
...
audio_clock_sig_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFF80000000"
        ...
        port map (
      I0 => audio_overclock_count_reg(3),
      I1 => audio_overclock_count_reg(1),
      I2 => audio_overclock_count_reg(0),
      I3 => audio_overclock_count_reg(2),
      I4 => audio_overclock_count_reg(4),
      I5 => \^audio_clk\,
      O => p_1_in
    );
...
\audio_overclock_count[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
        ...
        port map (
      I0 => audio_overclock_count_reg(0),
      O => plusOp(0)
    );
...
\audio_overclock_count[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      ...
      I0 => audio_overclock_count_reg(0),
      I1 => audio_overclock_count_reg(1),
      I2 => audio_overclock_count_reg(2),
      O => plusOp(2)
    );
\audio_overclock_count[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
        ...
        port map (
      I0 => audio_overclock_count_reg(1),
      I1 => audio_overclock_count_reg(0),
      I2 => audio_overclock_count_reg(2),
      I3 => audio_overclock_count_reg(3),
      O => plusOp(3)
    );
\audio_overclock_count[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
        ...
        port map (
      I0 => audio_overclock_count_reg(2),
      I1 => audio_overclock_count_reg(0),
      I2 => audio_overclock_count_reg(1),
      I3 => audio_overclock_count_reg(3),
      I4 => audio_overclock_count_reg(4),
      O => plusOp(4)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity minized_mic_microphone_mgr_0_0 is
  port (
    clk_in : in STD_LOGIC;
    resetn_in : in STD_LOGIC;
    AUDIO_CLK : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of minized_mic_microphone_mgr_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of minized_mic_microphone_mgr_0_0 : entity is "minized_mic_microphone_mgr_0_0,microphone_mgr,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of minized_mic_microphone_mgr_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of minized_mic_microphone_mgr_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of minized_mic_microphone_mgr_0_0 : entity is "microphone_mgr,Vivado 2019.1";
end minized_mic_microphone_mgr_0_0;

architecture STRUCTURE of minized_mic_microphone_mgr_0_0 is
  signal \^audio_data_vector_out\ : STD_LOGIC_VECTOR ( 1023 downto 0 );
  attribute x_interface_info : string;
  attribute x_interface_info of AUDIO_CLK : signal is "xilinx.com:signal:clock:1.0 AUDIO_CLK CLK";
  attribute x_interface_parameter : string;
  attribute x_interface_parameter of AUDIO_CLK : signal is "XIL_INTERFACENAME AUDIO_CLK, FREQ_HZ 2500000, PHASE 0.000, CLK_DOMAIN minized_mic_microphone_mgr_0_0_AUDIO_CLK, INSERT_VIP 0";
  attribute x_interface_info of clk_in : signal is "xilinx.com:signal:clock:1.0 clk_in CLK";
  attribute x_interface_parameter of clk_in : signal is "XIL_INTERFACENAME clk_in, ASSOCIATED_RESET resetn_in, FREQ_HZ 160000000, PHASE 0.000, CLK_DOMAIN minized_mic_processing_system7_0_0_FCLK_CLK2, INSERT_VIP 0";
  attribute x_interface_info of resetn_in : signal is "xilinx.com:signal:reset:1.0 resetn_in RST";
  attribute x_interface_parameter of resetn_in : signal is "XIL_INTERFACENAME resetn_in, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
  AUDIO_PDM <= \^audio_data_vector_out\(0);
  audio_data_vector_OUT(1023 downto 0) <= \^audio_data_vector_out\(1023 downto 0);
U0: entity work.minized_mic_microphone_mgr_0_0_microphone_mgr
     port map (
      AUDIO_CLK => AUDIO_CLK,
      AUDIO_DAT => AUDIO_DAT,
