...
HD_PWD='C:/Users/solbj/AppData/Roaming/Xilinx/Projects/minized_mic/MINIZED_2019_1/minized_mic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minized_mic_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minized_mic_wrapper.tcl
