...
HD_PWD='C:/Users/solbj/AppData/Roaming/Xilinx/Projects/minized_mic/MINIZED_2019_1/minized_mic.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log minized_mic_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source minized_mic_wrapper.tcl -notrace
