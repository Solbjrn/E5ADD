...
HD_PWD='C:/Users/solbj/AppData/Roaming/Xilinx/Projects/minized_mic/MINIZED_2019_1/minized_mic.runs/minized_mic_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log minized_mic_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source minized_mic_xbar_0.tcl
